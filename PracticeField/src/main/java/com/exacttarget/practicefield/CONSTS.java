...
public class CONSTS {
	...
	public static final int LAST_MESSAGE_ACTIVITY = 4;
	public static final int OPENDIRECT_ACTIVITY = 5;
	public static final int DISCOUNT_ACTIVITY = 6;
	public static final int INFO_ACTIVITY = 7;
	...
	public static final String KEY_PREF_DISCOUNT = "pref_discount";
