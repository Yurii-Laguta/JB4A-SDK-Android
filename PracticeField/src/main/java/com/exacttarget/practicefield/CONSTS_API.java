...
public class CONSTS_API {
	...
	//
	private static final String ET_APP_ID_DEV="[***REPLACE WITH YOUR KEY***]";
	private static final String ET_APP_ID_PROD="[***REPLACE WITH YOUR KEY***]";

	private static final String ET_ACCESS_TOKEN_DEV = "[***REPLACE WITH YOUR KEY***]";
	private static final String ET_ACCESS_TOKEN_PROD = "[***REPLACE WITH YOUR KEY***]";
	...
	//
	private static final String GCM_SENDER_ID_DEV = "[***REPLACE WITH YOUR KEY***]";
	private static final String GCM_SENDER_ID_PROD = "[***REPLACE WITH YOUR KEY***]";
	...
	private static final String ET_CLIENT_ID_DEV = "[***REPLACE WITH YOUR KEY***]";
	private static final String ET_CLIENT_ID_PROD = "[***REPLACE WITH YOUR KEY***]";

	private static final String ET_CLIENT_SECRET_DEV = "[***REPLACE WITH YOUR KEY***]";
	private static final String ET_CLIENT_SECRET_PROD = "[***REPLACE WITH YOUR KEY***]";
	...
	private static final String ET_MESSAGE_ID_DEV = "[***REPLACE WITH YOUR KEY***]";
	private static final String ET_MESSAGE_ID_PROD = "[***REPLACE WITH YOUR KEY***]";
