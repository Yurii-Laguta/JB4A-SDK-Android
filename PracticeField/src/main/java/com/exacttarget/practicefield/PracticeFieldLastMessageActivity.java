...
public class PracticeFieldLastMessageActivity extends ActionBarActivity {
	private int currentPage = CONSTS.LAST_MESSAGE_ACTIVITY;

	private static final String TAG = PracticeFieldLastMessageActivity.class.getName();
	...
	protected void onResume() {
		...
		Utils.setActivityTitle(this, R.string.last_message_activity_title);
			...
			if (payload.containsKey(CONSTS.KEY_PAYLOAD_DISCOUNT)) {
				...
				if (firstOpen) {
					...
					try {
						...
						Intent intent = new Intent(PracticeFieldLastMessageActivity.this, PracticeFieldDiscountActivity.class);
