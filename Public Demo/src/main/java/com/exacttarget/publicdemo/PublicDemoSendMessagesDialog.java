...
public class PublicDemoSendMessagesDialog extends Dialog {
	...
	private void prepareDisplay() {
		...
		demoDisclaimer.setText("Sending messages from an app that catches ET messages is not normally done.  We " +
				...
				"fully test the functionality of ET within this app.  Messages will only be sent to this device.");
		...
		discountCodesDescriptive.add("None");
		...
		btSend.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				sendMessage(outMsg, outTag, outKey);
	...
	//
	private void sendMessage(final String outMsg, final String outTag, final String outKey) {
