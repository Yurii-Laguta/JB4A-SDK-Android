...
public class CONSTS_API {
	...
	//
	private static final String ET_APP_ID_DEV="***REMOVED***";
	private static final String ET_APP_ID_PROD="***REMOVED***";

	private static final String ET_ACCESS_TOKEN_DEV = "***REMOVED***";
	private static final String ET_ACCESS_TOKEN_PROD = "***REMOVED***";
	...
	//
	private static final String GCM_SENDER_ID_DEV = "***REMOVED***";
	private static final String GCM_SENDER_ID_PROD = "***REMOVED***";
	...
	private static final String ET_CLIENT_ID_DEV = "***REMOVED***";
	private static final String ET_CLIENT_ID_PROD = "***REMOVED***";

	private static final String ET_CLIENT_SECRET_DEV = "***REMOVED***";
	private static final String ET_CLIENT_SECRET_PROD = "***REMOVED***";
	...
	private static final String ET_MESSAGE_ID_DEV = "***REMOVED***";
	private static final String ET_MESSAGE_ID_PROD = "***REMOVED***";
