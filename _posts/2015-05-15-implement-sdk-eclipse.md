...
1. Copy the <a href="https://github.com/ExactTarget/JB4A-SDK-Android/blob/master/JB4A-SDK/etsdk-4.2.0.jar?raw=true" target="_blank">etsdk-4.2.0.jar</a> into the **{project root}/libs** folder for your project.
