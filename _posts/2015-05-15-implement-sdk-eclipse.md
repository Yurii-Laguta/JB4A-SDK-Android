...
1.  Copy the `etsdk-{version}.jar` found <a href="https://github.com/ExactTarget/JB4A-SDK-Android/tree/master/JB4A-SDK" target="_blank">HERE</a> into the `{project root}/libs` folder for your project.
